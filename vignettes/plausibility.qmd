...
# import the data
df_mean <- readRDS("plausibility-df-mean.rds")
df_sd <- readRDS("plausibility-df-sd.rds")
df_fisher <- readRDS("plausibility-df-fisher.rds")
df_tippett <- readRDS("plausibility-df-tippett.rds")
```
